    ...
    try:
            ...
            try:
                ...
                rr = reader_agent.invoke({
                    "messages": [HumanMessage(
                        f"You have search results about '{topic_val}'. Your task is to:\n"
        ...
        with st.spinner("🧐  Critic is reviewing the report…"):
            ...
            try:
                ...
                st.warning(f"⚠️  Critic Chain Warning: {str(e)}. Skipping feedback.")
                results["critic"] = "Critic review unavailable due to API limits."
                st.session_state.results = dict(results)
